...
const PROCESSOR_SOURCE: &str = concat!(
    ...
    include_str!("writer_sleeve/participation.rs"),
    include_str!("writer_sleeve/dlmm.rs"),
    include_str!("writer_sleeve/dlmm/liquidity.rs"),
    include_str!("writer_sleeve/dlmm/swap.rs"),
    include_str!("ameba_dlmm/orders.rs"),
    include_str!("ameba_dlmm/orders/storage.rs"),
    include_str!("writer_sleeve/reconcile.rs"),
    include_str!("writer_sleeve/settlement.rs"),
    include_str!("writer_sleeve/collective_binding.rs"),
    include_str!("writer_sleeve/commitments.rs"),
    include_str!("writer_sleeve/custody.rs"),
    include_str!("writer_sleeve/dispatch.rs"),
    include_str!("writer_sleeve/initialization.rs"),
    include_str!("writer_sleeve/lifecycle.rs"),
    include_str!("writer_sleeve/metrics.rs"),
    include_str!("writer_sleeve/policy.rs"),
    include_str!("writer_sleeve/privileges.rs"),
);
