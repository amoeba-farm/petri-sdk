...
use crate::state::{
    OracleMonthState, OraclePhase, OracleSettlementStatus, WriterPolicyRegistryV1,
    WriterPolicySnapshotV1, WriterSeriesBookV1, WriterSeriesRecordV1, WriterSettlementGroupV1,
    WriterSleeveV1, WRITER_LIVE_SERIES_LIMIT, WRITER_SERIES_STORAGE_CAPACITY,
};
...
#[test]
fn writer_account_codecs_freeze_current_generation_lengths() {
    ...
    assert_writer_account_codec!(
        WriterSleeveV1,
        WriterSleeveV1 {
            capital_seconds: u128::MAX,
            maximum_contribution_duration: u64::MAX,
