...
impl BorshDeserialize for VaultInstruction {
    fn deserialize_reader<R: io::Read>(reader: &mut R) -> io::Result<Self> {
        ...
        match tag {
            ...
            VaultInstructionTag::InitializeWriterSleeveV1 => Ok(Self::InitializeWriterSleeveV1 { participation_start_ts: u64::deserialize_reader(reader)? }),
            ...
            VaultInstructionTag::PublishWriterGroupSettlementV1 => {
                ...
                if reader.read(&mut marker[..1])? == 0 {
                    return Ok(Self::PublishWriterGroupSettlementV1);
                }
                reader.read_exact(&mut marker[1..])?;
                if marker != crate::writer_settlement_handoff::HANDOFF_PAYLOAD {
                    return Err(io::Error::new(io::ErrorKind::InvalidData, "invalid writer handoff payload"));
                }
                Ok(Self::PublishWriterGroupSettlementWithHandoffV3)
            }
