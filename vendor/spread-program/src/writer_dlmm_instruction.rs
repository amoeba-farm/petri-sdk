...
pub enum ManageWriterDlmmV1Params {
    ...
    AppendPolicySeries { start_index: u8, entries: Vec<WriterDlmmSeriesPolicyV1> },
    SealPolicy,
    InitializePosition { series_index: u8 },
    AddLiquidity { series_index: u8, issue_amount_atoms: u64, entries: Vec<WriterDlmmBinV1> },
    RemoveLiquidity { series_index: u8, entries: Vec<WriterDlmmBinV1> },
    SweepCash { series_index: u8 },
}
...
impl BorshDeserialize for ManageWriterDlmmV1Params {
    fn deserialize_reader<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        Ok(match u8::deserialize_reader(reader)? {
            ...
            1 => Self::AppendPolicySeries { start_index: u8::deserialize_reader(reader)?,
                entries: read_entries(reader)? },
            2 => Self::SealPolicy,
            3 => Self::InitializePosition { series_index: u8::deserialize_reader(reader)? },
            4 => Self::AddLiquidity { series_index: u8::deserialize_reader(reader)?,
                issue_amount_atoms: u64::deserialize_reader(reader)?, entries: read_entries(reader)? },
            5 => Self::RemoveLiquidity { series_index: u8::deserialize_reader(reader)?,
                entries: read_entries(reader)? },
            6 => Self::SweepCash { series_index: u8::deserialize_reader(reader)? },
...
impl BorshSerialize for ManageWriterDlmmV1Params {
    fn serialize<W: std::io::Write>(&self, writer: &mut W) -> std::io::Result<()> {
        ...
        match self {
            ...
            Self::AppendPolicySeries { start_index, entries } => {
            ...
            Self::AddLiquidity { series_index, issue_amount_atoms, entries } => {
                BorshSerialize::serialize(series_index, writer)?;
                BorshSerialize::serialize(issue_amount_atoms, writer)?;
                write_entries(entries, writer)
            }
            Self::RemoveLiquidity { series_index, entries } => {
                BorshSerialize::serialize(series_index, writer)?;
                write_entries(entries, writer)
            }
        }
