...
mod compressed_transport_gate_tests {
    ...
    fn high_rent_create_decodes_before_requiring_compressed_transport() {
        ...
        .unwrap();
        assert_eq!(
            process_instruction(&Pubkey::new_unique(), &[], &data),
            Err(ProgramError::Custom(
    ...
    fn compressed_consumers_cannot_fall_back_to_classic_accounts() {
        ...
        for data in [
            ...
            vec![VaultInstructionTag::ResolveOracleEmergencyDisputeV4 as u8],
            vec![VaultInstructionTag::RegisterOracleSambaWinningVote as u8],
            vec![VaultInstructionTag::SettleOracleSambaEmergencyVoteV2 as u8],
