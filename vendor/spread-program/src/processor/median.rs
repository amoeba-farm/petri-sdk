...
pub(super) fn validate_oracle_observation_shape(
    ...
    if !matches!(observations.account_version,
        OracleSourceObservations::ACCOUNT_VERSION | OracleSourceObservations::INHERITED_ANCHOR_VERSION)
        || count == 0
...
pub fn oracle_temporal_median_state(
    ...
    let first_sample = usize::from(observations.account_version == OracleSourceObservations::INHERITED_ANCHOR_VERSION);
