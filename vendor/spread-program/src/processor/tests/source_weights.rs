...
fn temporal_median_observation_account_rejects_version_and_domain_substitution() {
    ...
    mutated.account_version = mutated.account_version.wrapping_add(1);
...
fn oracle_p0_handlers_allow_only_required_signer_writable_promotion() {
    ...
    assert_only_required_signer_writable_promotion_is_accepted(&reveal_accounts, |accounts| {
    ...
    assert_only_required_signer_writable_promotion_is_accepted(&finalize_accounts, |accounts| {
    ...
    assert_only_required_signer_writable_promotion_is_accepted(&recompute_accounts, |accounts| {
    ...
    let mut grace_recompute_accounts = recompute_accounts;
    grace_recompute_accounts.extend([
        blank_account_info(false, false),
        blank_account_info(false, true),
        blank_account_info(false, false),
    ]);
