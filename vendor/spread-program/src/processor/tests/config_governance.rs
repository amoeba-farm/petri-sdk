...
fn paused_bootstrap_setup_and_value_paths_use_their_exact_pause_guards() {
    ...
    for function_name in [
        ...
        "process_configure_oracle_major_token",
        "process_initialize_oracle_samba_pool",
        "process_initialize_oracle_reward_funnel",
    ] {
    ...
    for function_name in [
        "process_deposit_writer_principal",
        "process_commit_writer_auction",
        "process_begin_writer_close",
        "process_publish_writer_group_settlement",
        "process_claim_collective_long",
        "process_claim_writer_flat_residual",
    ] {
        assert!(
