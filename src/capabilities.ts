...
function defineCapability(
  id: string,
  descriptor: Omit<CapabilityDescriptor, "id">,
 ...
 */
export const CAPABILITIES: Readonly<Record<string, CapabilityDescriptor>> = Object.freeze({
...
function defineTuiCapability(
  descriptor: TuiCapabilityDescriptor,
): TuiCapabilityDescriptor {
 ...
 */
export const TUI_CAPABILITIES: readonly TuiCapabilityDescriptor[] = Object.freeze([
  defineTuiCapability({
    id: "home",
    mode: "presentation",
