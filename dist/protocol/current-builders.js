...
function assertCurrentOutput(value, builderName) {
...
export function invokeReleaseBoundCurrentBuilderV1(input) {
    ...
    return Object.freeze({
        value: assertCurrentOutput(registration.builder({ ...builderInput, programId: input.governedProgramId }), input.builderName),
