import type { CurrentOracleActionRequest, CurrentOracleRedactedRequest } from "./protocol/current-oracle-public.js";
...
interface CurrentChainIdentityDto {
    ...
    readonly governance?: {
        ...
        readonly gateStatus: 0 | 1 | 2;
        readonly epoch: string;
        readonly gateActive: boolean;
        readonly tradeReady: false;
...
type CurrentOracleLogicalInstructionTag = 131 | 133 | 138 | 139 | 155 | 161 | 162 | 163 | 165 | 166 | 168 | 174 | 176 | 177 | 181 | 182 | 183 | 198 | 199;
...
export type JsonRequestValue = JsonPrimitive | bigint | JsonRequestObject | JsonRequestValue[];
...
export type CurrentCollectiveOperationKind = "withdraw_principal" | "auction_refund" | "deposit" | "bid" | "close_begin" | "close_basket" | "close_finalize" | "close_cancel" | "settlement_claim_flat" | "settlement_claim_collective" | "transfer_flat" | "collective_swap_exact_in";
...
export interface CurrentTransactionPendingConfirmation {
    ...
    readonly reason: "signature_not_found" | "transaction_failed" | "not_confirmed" | "transaction_not_available";
}
...
export type CurrentTransactionConfirmation = CurrentTransactionPendingConfirmation | CurrentTransactionConfirmedConfirmation;
...
export type CurrentCollectiveOperationSubmitResponse = ApiSuccess<CurrentCollectiveOperationSubmitData>;
...
export type CurrentCollectiveOperationStatusResponse = ApiSuccess<CurrentCollectiveOperationStatusData>;
...
export type OracleDraftDecodedInstructionParams = {
    readonly instructionName: "SetComputeUnitLimit";
    readonly tag: 2;
    readonly oracleActionType?: never;
    readonly logicalInstructionName?: never;
    readonly logicalTag?: never;
} | {
    readonly instructionName: "CreateAssociatedTokenAccountIdempotent";
    readonly tag: 1;
    readonly oracleActionType?: never;
    readonly logicalInstructionName?: never;
    readonly logicalTag?: never;
...
export interface CurrentWriterRefundRow {
    ...
    readonly refundTokenAccount: string | null;
    readonly remainingRefundAtoms: string | null;
    readonly refundableNow: boolean;
...
export interface CurrentWriterLiquidityData extends CurrentResponseData {
    ...
    readonly managementAuthority: string | null;
    readonly actorCanManage: boolean;
    readonly policyLifecycle: "uncreated" | "building" | "sealed";
    readonly positionInitialized: boolean;
    readonly reasonCode: string | null;
    readonly accounting: {
        readonly assetsAtoms: string;
        readonly principalAtoms: string;
        readonly grossPrimaryPremiumAtoms: string;
        readonly reserveAtoms: string;
        readonly operationalBufferAtoms: string;
        readonly freeCashAtoms: string | null;
        readonly sleeveCashAtoms: string | null;
        readonly writerPoolQuoteAtoms: string | null;
        readonly writerUncommittedQuoteAtoms: string | null;
        readonly physicalSupplyAtoms: string;
        readonly issuerControlledAtoms: string;
        readonly externalOpenInterestAtoms: string;
        readonly positionOptionAtoms: string | null;
        readonly positionQuoteAtoms: string | null;
        readonly positionUncommittedQuoteAtoms: string | null;
    };
    readonly budget: null | {
        readonly monthStartUnixSeconds: string;
        readonly monthlyCapAtoms: string;
        readonly monthlySpentAtoms: string;
        readonly monthlyRemainingAtoms: string;
        readonly seriesMonthlyCapAtoms: string;
        readonly seriesMonthlySpentAtoms: string;
        readonly seriesMonthlyRemainingAtoms: string;
        readonly transactionCapAtoms: string;
        readonly seriesTransactionCapAtoms: string;
    ...
    readonly bins: readonly {
        ...
        readonly optionAtoms: string;
        readonly quoteAtoms: string;
    }[];
    readonly observedSlot: string;
